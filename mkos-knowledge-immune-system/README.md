...
This project was developed in close collaboration with AI coding tools — specifically Claude Code (Anthropic) as the primary development environment. The author designed the knowledge immune system architecture (KIS, thymus gate, stigmergy), formulated the biological analogies, and interpreted benchmark results. The AI assistant implemented the Python modules, test suite, benchmarks, and drafted documentation.

The honest accounting: code was predominantly generated by AI and reviewed by the human author. The architectural decisions — modeling knowledge management as an immune system, the choice of biological primitives (T-cells, thymus, stigmergy) — are human contributions inspired by immunology literature. The KIS threat detection module itself uses Claude Sonnet 4 for evaluation, creating a recursive dependency where AI evaluates AI-generated knowledge.
