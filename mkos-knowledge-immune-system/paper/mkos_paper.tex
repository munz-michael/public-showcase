...
% Gate decision
\node[box, fill=green!15, below=1.4cm of innate] (healthy) {\texttt{healthy}};
...
% Detector details below — shifted right to avoid known-arrow overlap
\node[font=\scriptsize, below right=0.15cm and -0.3cm of detectors, text width=2.2cm, align=center] (dlist) {Halluc.\ / Stale.\\Bias / Contrad.};

% Output
\node[box, fill=yellow!15, right=1.0cm of detectors] (output) {Scan\\Result};

% Hybrid search
\node[box, fill=cyan!10, below=1.4cm of detectors] (search) {Hybrid\\Search};
...
% Memory shortcut
\draw[arr] (memory.south) -- ++(0,-1.1) -| node[lbl, near start, below] {known} (output.south);
...
\section*{A Note on Process and Transparency}

The code for MKOS and KQAB was predominantly generated by AI and reviewed by the human author. The prose emerged through dialogue---AI drafts followed by human revision. Architecture decisions, research questions, experimental design, and interpretation of results are human contributions.
